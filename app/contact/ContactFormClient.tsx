            ...
            <div className="mt-12 border-t border-gray-200 pt-8 dark:border-gray-700">
              <div className="text-center text-gray-600 dark:text-gray-300">
                ...
                <div className="flex flex-col items-center justify-center space-y-2 sm:flex-row sm:space-x-6 sm:space-y-0">
                  <a href="mailto:luis@ruiztechservices.com" className="flex items-center transition-colors hover:text-indigo-600">
                    <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                      <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                    </svg>
                    luis@ruiztechservices.com
                  </a>
                  <a href="tel:+13479013772" className="flex items-center transition-colors hover:text-indigo-600">
                    <svg className="mr-2 h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
